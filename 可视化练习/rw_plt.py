...
while True:
    ...
    plt.plot(0,0,linewidth=50)
    #plt.plot(rw.x_values[-1],rw.y_values[-1],c="Blue",edgecolors='none',s=50)
    #plt.plot(max(rw.x_values),min(rw.y_values),c="Yellow",edgecolors='none',s=50)'''
